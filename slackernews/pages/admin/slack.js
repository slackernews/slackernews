      ...
      <div>
        {isConfiguredInEnv ?
          <div className="alert alert-warning" role="alert">
            The Slack configuration was provided in the <Link href="/admin/admin-console">Admin
            Console</Link> configuration
            and is not editable here. To reconfigure the Slack integration, please update the configuration in the Admin
            Console.
          </div>
          :
          <div className="alert alert-info" role="alert">
            Instructions for creating and configuring the Slack application can be found in the <Link
            href="https://docs.slackernews.io/slack">documentation</Link>.
          </div>
        }
        <form>
          <div className="form-group">
            ...
            <input type="text" disabled={isConfiguredInEnv} className="form-control" id="slackBotToken"
                   placeholder="Enter bot token" value={botToken} onChange={(e) => {
              setBotToken(e.target.value);
            }}/>

            <label htmlFor="slackUserToken">User Token</label>
            <input type="text" disabled={isConfiguredInEnv} className="form-control" id="slackUserToken"
                   placeholder="Enter user token" value={userToken} onChange={(e) => {
              setUserToken(e.target.value);
            }}/>

            <label htmlFor="slackClientId">Client ID</label>
            <input type="text" disabled={isConfiguredInEnv} className="form-control" id="slackClientId"
                   placeholder="Enter client ID" value={clientId} onChange={(e) => {
              setClientId(e.target.value);
            }}/>

            <label htmlFor="slackClientSecret">Client Secret</label>
            <input type="text" disabled={isConfiguredInEnv} className="form-control" id="slackClientSecret"
                   placeholder="Enter client secret" value={clientSecret} onChange={(e) => {
